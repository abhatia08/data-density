...
# MAGIC %md
# MAGIC **Purpose**: Apply rules-based and pretrained GMM (K=4, K=7) clustering to cohort_2a person-year features (no retraining; reuse cohort_1 models).
...
features.cache()
features.count()  # Materialize cache
...
# Model bundle names (expected to be pickled dicts with model/scaler/winsor caps)
GMM4_MODEL_ID = "gmm_4"
GMM7_MODEL_ID = "gmm_7"
